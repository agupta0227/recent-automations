Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        OpenFileDialog1.Title = "Please select the Lumico.AI file"
        OpenFileDialog1.FileName = ""
        OpenFileDialog1.Filter = "AI Files (*.AI)|*.AI"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i As Integer = 0 To LumArray.Count - 1
            If LumArray.Item(i).ToString.Trim.Split(";").GetValue(1).ToString.Trim.Contains("(855) 774-4491") Then
                BUname = ""
        ...
        If CheckBox1.CheckState = CheckState.Checked Then
            LumWriter = IO.File.CreateText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\" & "LumicoFileParser_Debug_" & DateTime.Now.Ticks & ".txt")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        For Each BU In FindBU
            ...
            For Each ln In GetLineNum
                Do Until LumArray.Item(ln).ToString.Trim.Split(";").GetValue(1).ToString.Trim.StartsWith("(855) 774-4491")
            ...
            LumWriter = IO.File.CreateText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\" & "LumicoFileParser_" & BU & "_" & DateTime.Now.Ticks & ".txt")
